...
def do_event_based(loss_type, units, containers, params, profile):
    ...
    for unit in units:
        ...
        for site_id, assets in unit.getter:
            ...
            outputs = individual_outputs(loss_type, unit, site_id, assets,
                                         params, profile)
...
def individual_outputs(loss_type, unit, site_id, assets, params, profile):
    ...
    with profile('getting gmvs and ruptures'):
        gmvs, ruptures = unit.getter.get_gmvs_ruptures(site_id)

    with profile('computing losses, loss curves and maps'):
        loss_matrix, curves = unit.calc([gmvs] * len(assets))
