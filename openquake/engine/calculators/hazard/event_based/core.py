...
def _compute_gmf(params, imt, gsims, site_coll, ruptures, rupture_seeds):
    ...
    Assume the ruptures have been already filtered with a rupture_site_filter.
    ...
    # compute ground motion fields generated by the (filtered) ruptures
    ...
    def task_arg_gen(self):
        ...
        for lt_rlz in self._get_realizations():
            ...
            for src_ids in block_splitter(
                ...
                with self.monitor('filtering sources'):
